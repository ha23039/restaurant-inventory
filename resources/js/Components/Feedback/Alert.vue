...
<template>
    <div :class="[alertClasses, 'border rounded-lg p-4']">
        <div class="flex">
            <div class="flex-shrink-0">
                <svg :class="iconClasses" class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div v-if="closeable" class="ml-auto pl-3">
                <button
                    type="button"
                    class="-mx-1.5 -my-1.5 rounded-lg p-1.5 inline-flex h-8 w-8 hover:bg-gray-100"
                    @click="emit('close')"
                >
