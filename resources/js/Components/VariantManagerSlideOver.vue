...
const loadVariants = async () => {
    ...
    loading.value = true;
    try {
        const response = await fetch(route('api.menu-items.variants', props.menuItem.id));
...
const groupedVariants = computed(() => {
    ...
    variants.value.forEach(variant => {
        const masa = variant.attributes?.masa || 'otros';
        if (groups[masa]) {
            groups[masa].push(variant);
        } else {
            groups.otros.push(variant);
        }
    });
    ...
    >
        <div class="space-y-6">
            ...
            <div v-else-if="variants.length === 0" class="text-center py-12">
                ...
                <p class="text-xs text-gray-400 dark:text-gray-500">Las variantes se gestionan actualmente mediante seeders</p>
            </div>
            ...
            <div v-else class="space-y-6">
                ...
                <div v-if="groupedVariants.maiz.length > 0">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-3 flex items-center">
                        ...
                        Masa de Maiz ({{ groupedVariants.maiz.length }})
                    </h3>
                    <div class="space-y-3">
                        <div
                ...
                <div v-if="groupedVariants.arroz.length > 0">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-3 flex items-center">
                        ...
                        Masa de Arroz ({{ groupedVariants.arroz.length }})
                    </h3>
                    <div class="space-y-3">
                        <div
