            ...
            <div class="mx-auto max-w-7xl">
                ...
                <div v-if="!currentSession">
                    <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        <div class="p-12 text-center">
                            ...
                            <h3 class="mb-2 text-lg font-semibold text-gray-900">No hay sesión de caja abierta</h3>
                ...
                <div v-else class="space-y-6">
                            ...
                            <div class="p-6">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p class="text-2xl font-semibold text-gray-900">${{ formatPrice(currentSession.opening_amount) }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="p-6">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <p class="text-sm font-medium text-gray-500">Ventas Efectivo</p>
                                        <p class="text-2xl font-semibold text-gray-900">${{ formatPrice(currentSession.total_cash_sales) }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="p-6">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p class="text-2xl font-semibold text-gray-900">${{ formatPrice(currentSession.total_all_sales) }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="p-6">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p class="text-2xl font-semibold text-gray-900">{{ currentSession.transaction_count }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div class="p-6">
                                ...
                                <dl class="space-y-3">
                                    <div class="flex justify-between">
                                        ...
                                        <dd class="text-sm font-medium text-gray-900">{{ currentSession.user.name }}</dd>
                                    </div>
                                    <div class="flex justify-between">
                                        <dt class="text-sm text-gray-500">Apertura:</dt>
                                        <dd class="text-sm font-medium text-gray-900">{{ formatDateTime(currentSession.opened_at) }}</dd>
                                    </div>
                                    <div class="flex justify-between">
                                        <dt class="text-sm text-gray-500">Duración:</dt>
                                        <dd class="text-sm font-medium text-gray-900">{{ currentSession.duration_hours }} horas</dd>
                                    </div>
                                    <div v-if="currentSession.opening_notes" class="pt-3 border-t">
                                        <dt class="text-sm text-gray-500 mb-1">Notas de Apertura:</dt>
                                        <dd class="text-sm text-gray-700 bg-gray-50 p-2 rounded">{{ currentSession.opening_notes }}</dd>
                                    </div>
                                </dl>
                            </div>
                        </div>
                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="p-6">
                                <h3 class="text-lg font-semibold text-gray-900 mb-4">Desglose por Método de Pago</h3>
                                <div class="space-y-3">
                                    <div class="flex justify-between items-center pb-2 border-b">
                                        <span class="text-sm text-gray-600">Efectivo</span>
                                        <span class="text-sm font-semibold text-green-600">${{ formatPrice(currentSession.total_cash_sales) }}</span>
                                    </div>
                                    <div class="flex justify-between items-center pb-2 border-b">
                                        <span class="text-sm text-gray-600">Tarjeta</span>
                                        <span class="text-sm font-semibold text-blue-600">${{ formatPrice(currentSession.total_card_sales) }}</span>
                                    </div>
                                    <div class="flex justify-between items-center pb-2 border-b">
                                        <span class="text-sm text-gray-600">Transferencia</span>
                                        <span class="text-sm font-semibold text-purple-600">${{ formatPrice(currentSession.total_transfer_sales) }}</span>
                                    </div>
                                    <div class="flex justify-between items-center pt-2 border-t-2">
                                        <span class="text-base font-semibold text-gray-900">Total</span>
                                        <span class="text-lg font-bold text-gray-900">${{ formatPrice(currentSession.total_all_sales) }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex flex-wrap gap-3">
                                ...
                                <template v-if="isAdmin()">
                                    <Link
                                        ...
                                        class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500"
                                    >
                                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
