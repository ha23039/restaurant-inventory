        ...
        <div class="py-3 md:py-6 lg:py-12 px-2 sm:px-6 lg:px-8 space-y-6">
            <div class="mx-auto max-w-4xl space-y-6">
                ...
                <div class="overflow-hidden bg-white dark:bg-gray-900 shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Resumen de Turno</h3>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <!-- Monto Inicial -->
                            <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                                <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">Monto Inicial</p>
                                <p class="text-2xl font-bold text-gray-900 dark:text-white">${{ formatPrice(session.opening_amount) }}</p>
                            ...
                            <!-- Duración -->
                            <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                                <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">Duración del Turno</p>
                                <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ session.duration_hours }} hrs</p>
                                <p class="text-xs text-gray-500 dark:text-gray-500 mt-1">
                        ...
                        <div class="border-t border-gray-200 dark:border-gray-700 pt-4">
                            <h4 class="font-semibold text-gray-900 dark:text-white mb-3">Ventas por Método de Pago</h4>
                            <div class="space-y-2">
                                <div class="flex justify-between items-center py-2 border-b border-gray-100 dark:border-gray-800">
                                    ...
                                    <span class="text-lg font-semibold text-green-600 dark:text-green-400">${{ formatPrice(session.total_cash_sales) }}</span>
                                </div>
                                <div class="flex justify-between items-center py-2 border-b border-gray-100 dark:border-gray-800">
                                    <span class="text-sm text-gray-600 dark:text-gray-400 flex items-center">
                                    ...
                                    <span class="text-lg font-semibold text-blue-600 dark:text-blue-400">${{ formatPrice(session.total_card_sales) }}</span>
                                </div>
                                <div class="flex justify-between items-center py-2 border-b border-gray-100 dark:border-gray-800">
                                    <span class="text-sm text-gray-600 dark:text-gray-400 flex items-center">
                                    ...
                                    <span class="text-lg font-semibold text-purple-600 dark:text-purple-400">${{ formatPrice(session.total_transfer_sales) }}</span>
                                </div>
                                <div class="flex justify-between items-center py-2 pt-4 border-t-2 border-gray-300 dark:border-gray-600">
                                    <span class="text-base font-semibold text-gray-900 dark:text-white">Total Ventas</span>
                                    <span class="text-xl font-bold text-gray-900 dark:text-white">${{ formatPrice(session.total_all_sales) }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-6 bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border border-blue-200 dark:border-blue-800">
                            <div class="flex justify-between items-center">
                                <div>
                                    <p class="text-sm font-medium text-blue-900 dark:text-blue-300">Efectivo Esperado en Caja</p>
                                    <p class="text-xs text-blue-700 dark:text-blue-400 mt-1">Inicial + Ventas en Efectivo</p>
                                </div>
                                <p class="text-2xl font-bold text-blue-900 dark:text-blue-300">${{ formatPrice(session.expected_closing) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="overflow-hidden bg-white dark:bg-gray-900 shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Conteo de Efectivo</h3>

                        <form @submit.prevent="submitForm">
                            <!-- Monto de Cierre -->
                            <div class="mb-6">
                                <label for="closing_amount" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input
                                        ...
                                        min="0"
                                        required
                                        class="w-full pl-8 pr-4 py-3 text-lg border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white rounded-lg focus:ring-blue-500 focus:border-blue-500"
                                        placeholder="0.00"
                                        autofocus
                            ...
                            <div v-if="form.closing_amount" class="mb-6">
                                <div
                                    :class="[
                                        ...
                                        difference === 0 ? 'bg-green-50 dark:bg-green-900/20 border-green-300 dark:border-green-700' :
                                        difference > 0 ? 'bg-yellow-50 dark:bg-yellow-900/20 border-yellow-300 dark:border-yellow-700' :
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div>
                                            <p class="font-semibold" :class="[
                                                difference === 0 ? 'text-green-800 dark:text-green-300' :
                                                difference > 0 ? 'text-yellow-800 dark:text-yellow-300' :
                            ...
                            <div class="mb-6">
                                ...
                                <textarea
                                    ...
                                    rows="3"
                                    maxlength="1000"
                                    class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white rounded-lg focus:ring-blue-500 focus:border-blue-500"
                                ...
                                <div class="mt-1 flex justify-between">
                                    ...
                                    <span class="text-xs text-gray-400 dark:text-gray-500">{{ form.closing_notes?.length || 0 }}/1000</span>
                                </div>
                                <InputError :message="errors.closing_notes" class="mt-2" />
                            </div>

                            <!-- Advertencia si hay faltante grande -->
                            <div v-if="difference < -50" class="mb-6 rounded-lg bg-red-50 dark:bg-red-900/20 p-4 border border-red-200 dark:border-red-800">
                                <div class="flex">
                                    <svg class="h-5 w-5 text-red-600 dark:text-red-400 mr-3 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
