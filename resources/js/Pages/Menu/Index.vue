            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <Link
                        ...
                        class="bg-gradient-to-br from-blue-50 to-blue-100 border-2 border-blue-200 rounded-lg p-6 hover:shadow-lg transition-all transform hover:-translate-y-1"
                    >
                        ...
                        <h3 class="text-xl font-semibold text-blue-900 mb-2">Platillos del Menú</h3>
                        <p class="text-sm text-blue-700 mb-4">Gestiona los platillos que se venden en el restaurante</p>
                    ...
                    <Link
                        ...
                        class="bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-200 rounded-lg p-6 hover:shadow-lg transition-all transform hover:-translate-y-1"
                    >
                        <div class="flex items-center mb-4">
                        ...
                        <h3 class="text-xl font-semibold text-purple-900 mb-2">Recetas</h3>
                        <p class="text-sm text-purple-700 mb-4">Define ingredientes y cantidades para cada platillo</p>
                    ...
                    <!-- Productos Simples -->
                    <div class="bg-gradient-to-br from-green-50 to-green-100 border-2 border-green-200 rounded-lg p-6 hover:shadow-lg transition-all transform hover:-translate-y-1 opacity-75">
                        <div class="flex items-center mb-4">
                        ...
                        <h3 class="text-xl font-semibold text-green-900 mb-2">Productos Simples</h3>
                        <p class="text-sm text-green-700 mb-4">Productos individuales sin receta (bebidas, extras)</p>
